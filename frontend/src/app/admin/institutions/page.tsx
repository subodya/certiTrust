  ...
  return (
    <main className="mx-auto max-w-5xl p-6">
      ...
      <section className="mb-6 rounded-2xl border border-[var(--border-soft)] bg-white p-5">
        <h2 className="mb-4 text-xs font-semibold uppercase tracking-wide text-slate-500">Add Institution</h2>
        {addError && (
        ...
        >
          <div>
            <label className="mb-1 block text-xs font-medium text-slate-500">Institution Name *</label>
            <input
              className={inputCls}
